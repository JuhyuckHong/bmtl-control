...
export const ApiDocsPage = () => {
  const mqttEndpoints = [
    // 발행 메시지 (Publish)
    {
      ...
      description:
        '전체 설정 불러오기 요청 (각 모듈은 bmtl/status/health/{device_id}로 개별 응답)',
      qos: '2',
    },
    {
      type: 'Publish',
    ...
    },
    {
      ...
      description: '개별 모듈 사이트명 변경 (01번 모듈 예시)',
      qos: '2',
      payload: {
        sitename: '새로운 사이트명',
      },
    ...
    },
    {
      ...
      description:
        '전체 모듈 상태 요청 (각 모듈은 bmtl/status/health/{device_id}로 응답)',
      qos: '2',
    },
    // 구독 메시지 (Subscribe)
    {
      ...
      <section className='patterns-section'>
        ...
        <div className='pattern-list'>
          ...
          <div className='pattern-item'>
            ...
            <span>설정 요청 (all은 시스템으로 응답, 모듈번호는 개별 응답)</span>
          </div>
          <div className='pattern-item'>
          ...
          <div className='pattern-item'>
            ...
            <span>개별 모듈 옵션 요청 (모듈번호 또는 all)</span>
          </div>
          <div className='pattern-item'>
            <code>bmtl/response/options/+</code>
            <span>개별 모듈 옵션 응답 (모듈번호 또는 all)</span>
          </div>
          <div className='pattern-item'>
          ...
          <div className='pattern-item'>
            ...
            <span>사이트명 변경 요청 (모듈번호)</span>
          </div>
          <div className='pattern-item'>
            <code>bmtl/response/set/sitename/+</code>
            <span>사이트명 변경 응답 (모듈번호)</span>
          </div>
          <div className='pattern-item'>
          ...
          <div className='pattern-item'>
            ...
            <span>상태 요청 (all 또는 모듈번호, 헬스로 응답)</span>
          </div>
        </div>
      </section>
